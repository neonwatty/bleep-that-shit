...
test.describe('Pattern Matching Modes', () => {
  ...
  test('should match words in exact mode', async () => {
    ...
    const exactCheckbox = bleepPage.exactMatchCheckbox;
    await exactCheckbox.check();

    // Uncheck other modes
    const partialCheckbox = bleepPage.partialMatchCheckbox;
    const fuzzyCheckbox = bleepPage.fuzzyMatchCheckbox;
  ...
  test('should adjust fuzzy distance slider (1-3)', async () => {
    ...
    const fuzzySlider = bleepPage.fuzzyDistanceSlider;
