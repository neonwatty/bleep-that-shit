...
export function UpgradeModal({ isOpen, onClose, featureName = 'Cloud Transcription' }: UpgradeModalProps) {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="relative w-full max-w-md animate-in fade-in zoom-in-95 rounded-2xl bg-white p-6 shadow-xl duration-200"
      >
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <p className="mb-6 text-center text-gray-600">
          Get access to cloud-powered transcription with the highest accuracy and fastest processing speeds.
        </p>
