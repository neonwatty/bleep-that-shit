        ...
        <div>
          ...
          <div className="relative mt-1">
            <input
              ...
              required
              minLength={6}
              className="block w-full rounded-lg border border-gray-300 px-4 py-3 pr-12 shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
